...
#setwd("~/misc/")
#b1 <- import("1746_D_dieterich.slim.bed")
#b2 <- import("1746_H_dieterich.slim.bed")

cat("* Finding mismatches btw ends of transcripts & ends of outermost exons (blocks) ...\n")
# function to get rid of mismatching transcripts
...
if (length(b1_sel)==0) b1_sel <- b1
if (length(b2_sel)==0) b2_sel <- b2
